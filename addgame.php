...
if(!isset($_POST["game_name"]))exit;
if(!isset($_POST["game_developer"]))exit;
if(!isset($_POST["game_release_date"]))exit;
if(!isset($_POST["game_genre"]))exit;
if(!isset($_POST["game_description"]))exit;
if(!isset($_POST["game_image"]))exit;
