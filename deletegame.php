...
$game_id = $_POST["game_id"];
$q = mysqli_query($db, // Oyun bilgilerini al
    "SELECT games.* FROM games WHERE games.game_id = '$game_id'");
$row_num = mysqli_num_rows($q);
if($row_num == 0) redirectTo("index.php",0); // Oyun IDsi bulunamazsa ana menuye geri dön
...
<div>
    <form class="form" id="gameForm" action="deletegame.php" method="post">
        ...
        <br><br>
        <div class="fw center">
            <button class="btn green p1 wt" type="submit" name="delete" value="false">Vazgeç</button>
